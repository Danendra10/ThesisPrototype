...
float variasi_halangan_1_y[] = {Y_FIELD_1_2 - 200, Y_FIELD_1_2 - 200, Y_FIELD_1_2 - 200, Y_FIELD_1_2 - 200};
float variasi_halangan_2_y[] = {Y_FIELD_1_2 + 200, Y_FIELD_1_2 + 200, Y_FIELD_1_2 + 200, Y_FIELD_1_2 + 200};
float variasi_halangan_1_x[] = {X_FIELD_1_2 + 50 + 100, X_FIELD_1_2 + 50 + 100, X_FIELD_1_2 + 50 + 250, X_FIELD_1_2 - 50 - 100};
float variasi_halangan_2_x[] = {X_FIELD_1_2 + 50 + 100, X_FIELD_1_2 + 50 + 250, X_FIELD_1_2 + 50 + 100, X_FIELD_1_2 + 50 + 250};
...
void DrawOurRobot()
{
    ...
    DrawRobot(enemy[0].pose_x, enemy[0].pose_y, enemy[0].pose_th, CV_RED);
    DrawRobot(enemy[1].pose_x, enemy[1].pose_y, enemy[1].pose_th, CV_RED);
}
