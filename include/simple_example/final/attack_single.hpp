...
RobotEntity enemy[2] = {
    RobotEntity(0, 700, 200 + 100, 90),
    RobotEntity(0, 1000 - 150, 300 + 100, 90)};

vector<Point2f> obstacles = {
    {700, 200 + 100}, {1000 - 150, 300 + 100}};
...
Point2f robot_vel;
Point2f movement_points = {robot[0].pose_x, robot[0].pose_y};
vector<Point2f> vec_movement_points;
