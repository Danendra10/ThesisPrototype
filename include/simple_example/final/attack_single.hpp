...
RobotEntity robot[2] = {
    RobotEntity(1, X_FIELD_1_2 - 20, Y_FIELD_1_2, 0),
...
RobotEntity enemy[2] = {
    RobotEntity(0, variasi_halangan_1_x[3], variasi_halangan_1_y[3], 90),
    RobotEntity(0, variasi_halangan_2_x[3], variasi_halangan_2_y[3], 90)};
